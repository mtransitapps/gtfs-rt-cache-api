export const getAgencyConfigs = (env) => ({
  ...
  "ca_l_assomption_mrclasso": { // exo LASSO // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/MRCLASSO/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_la_presqu_ile_citpi": { // exo PI // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/CITPI/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_laurentides_citla": { // exo LA // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/CITLA/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_le_richelain_citlr": { // exo LRRS (Le Richelain / Roussillon) // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/LRRS/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_les_moulins_mrclm": { // exo Terrebonne-Mascouche // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/MRCLM/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_longueuil_rtl": { // RTL // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://rtl.chrono-saeiv.com/api/opendata/v1/RTL/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_montreal_amt": { // exo trains // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/TRAINS/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_richelieu_citvr": { // exo VR // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/CITVR/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_sherbrooke_sts": { // STS // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://sts.chrono-saeiv.com/api/opendata/v1/STS/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_sorel_varennes_citsv": { // exo SV // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/CITSV/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_ste_julie_omitsju": { // exo SJU // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/OMITSJU/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
  ...
  "ca_sud_ouest_citso": { // exo SO // min interval of 05 seconds between each call to service
    ...
    tripUpdatesUrlWithSecret: `https://exo.chrono-saeiv.com/api/opendata/v1/CITSO/tripupdate?token=${env.MT_GTFS_RT_ca_chambly_richelieu_carignan_citcrc}`,
